      ...
      <section className="relative h-screen justify-center items-center w-full bg-black overflow-x-hidden pt-[100px]">
        <div className="flex justify-between items-center container mx-auto px-4 gap-2">
          <motion.div
            ...
            className="relative w-full lg:flex-[1.6] h-[280px] md:h-[350px] lg:h-[300px] rounded-2xl md:rounded-3xl overflow-hidden bg-[url('/images/home/heroImg1.png')] bg-cover bg-center shadow-2xl"
          >
                ...
                {labels.slice(0, 3).map((label, idx) => (
                  <React.Fragment key={label}>
                    <motion.div
                      ...
                      className="px-2 py-1 md:px-3 md:py-1.5 bg-transparent border-blue-600  backdrop-blur-md rounded-full text-[10px] md:text-xs font-medium text-white shadow-sm"
                    >
                      {label}
                    </motion.div>
                    {idx < 2 && (
                ...
                {labels.slice(3).map((label, idx) => (
                  <React.Fragment key={label}>
                    <motion.div
                      ...
                      className="px-2 py-1 md:px-3 md:py-1.5 backdrop-blur-sm rounded-full text-[10px] md:text-xs font-medium text-blue-white shadow-sm"
                    >
                      {label}
                    </motion.div>
                    {idx < 2 && (
          ...
          {/* Tab 02 - Marketing */}
          <div className="hidden lg:flex flex-col gap-5 h-[280px] md:h-[350px] lg:h-[300px] justify-center">
            <motion.div
              initial={{ opacity: 0, scale: 0.8 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ delay: 0.4 }}
              className="relative w-12 md:w-14 h-full rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 bg-linear-to-t from-[#2052bd] to-[#7fcbe4] shadow-lg"
            >
              <div
          ...
          <div className="hidden lg:flex flex-col gap-5 h-[280px] md:h-[350px] lg:h-[300px] justify-center">
            <motion.div
              ...
              className="relative w-12 md:w-14 h-full rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 bg-linear-to-b bg-[#2052bd] to-[#7fcbe4] shadow-md"
            >
              <div
          ...
          <motion.div
            ...
            className="relative w-full lg:flex-[0.9] h-[280px] md:h-[350px] lg:h-[300px] rounded-2xl md:rounded-3xl overflow-hidden"
          >
            ...
            <div className="relative h-full flex flex-col justify-between p-4 z-10 bg-[url('/images/home/heroImg2.jpg')] bg-cover bg-center rounded-2xl md:rounded-3xl shadow-2xl">
              <div className="backdrop-blur-md border border-blue-500/20 p-4 rounded-2xl shadow-lg">
                {/* Section Number - Light gray circle with dark gray number */}
                ...
                <div className="flex-1 flex flex-col justify-center items-center text-center space-y-2 md:space-y-4 mt-4 md:mt-6">
                  ...
                  >
                    Discover endless possibilities with Spark's innovative
                    design solutions.
                  </motion.p>
                </div>
                ...
                <motion.button
                  ...
                  className="self-start px-3 py-1.5 md:px-4 md:py-2 bg-linear-to-t from-[#2052bd] to-[#7fcbe4] backdrop-blur-sm rounded-full border border-white/60 shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-1.5 md:gap-2 text-white text-xs md:text-sm font-semibold hover:bg-blue-200/90"
                >
                  Explore Now
                  <svg
                    className="w-5 h-5"
          ...
          <div className="hidden lg:flex flex-col gap-5 h-[280px] md:h-[350px] lg:h-[300px] justify-center">
            <motion.div
              ...
              className="relative w-12 md:w-14 h-full rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 bg-linear-to-b from-[#2052bd] to-[#7fcbe4] shadow-lg"
            >
              <div
                className="text-xs font-bold text-white"
                style={{
          ...
          <div className="hidden lg:flex flex-col gap-5 h-[280px] md:h-[350px] lg:h-[300px] justify-center">
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              transition={{ delay: 0.7 }}
              className="relative w-12 md:w-14 h-full rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 bg-linear-to-t from-[#2052bd] to-[#7fcbe4] shadow-md"
            >
              <div
                className="text-xs font-normal text-white"
                style={{
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 lg:gap-6">
            ...
            <div className="flex-1 w-full lg:w-auto">
              <motion.h1
                ...
                className="text-3xl sm:text-4xl md:text-5xl bg-linear-to-tr from-[#2052bd] to-[#7fcbe4] bg-clip-text text-transparent leading-[1.1] mb-6 max-w-5xl"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-4 py-2 md:px-5 md:py-2 bg-linear-to-tr from-[#2052bd] to-[#7fcbe4] text-white rounded-full font-semibold flex items-center gap-2 hover:gap-4 transition-colors shadow-lg text-xs md:text-sm"
              >
                Create project
                <svg
                  className="w-5 h-5"
            ...
            <div className="flex-1 w-full lg:w-auto grid grid-cols-2 lg:flex gap-2 md:gap-3">
              ...
              <motion.div
                ...
                className="flex-1 bg-linear-to-tr from-[#2052bd] to-[#7fcbe4] rounded-xl p-2 md:p-3 flex items-center gap-2 md:gap-3 min-w-0 shadow-lg"
              >
                ...
                <div className="min-w-0">
                  <p className="text-[10px] md:text-xs text-white mb-0.5">
                    Impressions:
                  </p>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm md:text-lg font-bold text-white">35%</p>
                </div>
              </motion.div>
