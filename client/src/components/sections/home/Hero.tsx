...
export const Hero: React.FC = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-white p-3 md:p-6 overflow-x-hidden">
      ...
      <div className="max-w-[1800px] mx-auto mt-2 md:mt-4 px-2 md:px-4 flex flex-col lg:flex-row items-center gap-2 md:gap-4 lg:gap-6 overflow-x-hidden">
        ...
        >
          ...
          <div className="absolute inset-0">
            {/* Base texture layers */}
            <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(255,255,255,0.1)_0%,transparent_25%,rgba(0,0,0,0.1)_50%,transparent_75%,rgba(255,255,255,0.08)_100%)]"></div>
            <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_20%,rgba(255,255,255,0.12)_30%,transparent_40%,rgba(0,0,0,0.08)_50%,transparent_60%,rgba(255,255,255,0.1)_70%,transparent_80%)]"></div>
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_20%_30%,rgba(255,255,255,0.15)_0%,transparent_40%)]"></div>
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_80%_70%,rgba(0,0,0,0.1)_0%,transparent_50%)]"></div>
            {/* Folds and creases */}
            <div className="absolute top-0 left-0 w-full h-1/3 bg-[linear-gradient(to_bottom,rgba(255,255,255,0.08),transparent)]"></div>
            <div className="absolute bottom-0 right-0 w-2/3 h-1/2 bg-[linear-gradient(to_top,rgba(0,0,0,0.12),transparent)]"></div>
          </div>

          {/* White Spheres - One on left, one centered, one on right */}
          <div className="absolute left-[-20px] md:left-[-40px] top-[20%] w-24 h-24 md:w-32 md:h-32 bg-white rounded-full opacity-70 shadow-2xl"></div>
          ...
          <div className="relative h-full flex flex-col justify-between p-4 md:p-6 lg:p-8 z-10">
            ...
            <div className="flex-1 flex flex-col justify-center items-center text-center space-y-2 md:space-y-4 mt-4 md:mt-6">
              <motion.h1
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.5 }}
                className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white leading-[1.1] tracking-tight px-2"
              >
      ...
      {/* Bottom Section - Metrics and Data Insights */}
      <div className="max-w-[1800px] mx-auto mt-2 md:mt-4 px-2 md:px-4">
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 lg:gap-6">
          ...
          <div className="flex-1 w-full lg:w-auto">
            <motion.h2
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
              className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight mb-3 md:mb-4"
            >
              Fueling growth
              <br />
              with data Insights
